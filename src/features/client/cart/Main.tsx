...
const CartSummary = () => {
  ...
  const { subtotal, discount, deliveryFee, total, isUpdating } = useCart();
    ...
    <aside className="flex h-fit flex-col gap-3 border border-border bg-background p-3 lg:gap-4 lg:p-4">
      ...
      <div className="flex flex-col gap-3 text-sm lg:gap-4">
        <div className="flex items-center justify-between gap-3 lg:gap-4">
          ...
          {isUpdating ? (
            <Skeleton width={80} height={16} color="NEUTRAL" />
          ) : (
        ...
        <div className="flex items-center justify-between gap-3 lg:gap-4">
          ...
          {isUpdating ? (
            <Skeleton width={65} height={16} color="NEUTRAL" />
          ) : (
            <span className="font-medium">
        ...
        <div className="border-t border-border pt-3 lg:pt-4">
          <div className="flex items-center justify-between gap-4">
            ...
            {isUpdating ? (
              <Skeleton width={105} height={26} color="MAIN" />
            ) : (
